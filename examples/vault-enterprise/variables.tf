...
# ---------------------------------------------------------------------------------------------------------------------
# REQUIRED PARAMETERS
# These parameters require definition
# ---------------------------------------------------------------------------------------------------------------------

variable "aws_region" {
  description = "The AWS region for Vault deployment"
  type        = string
}
...
variable "vault_cluster_allowed_ssh_cidr_blocks" {
  description = "List of CIDR blocks allowed to access Vault cluster via SSH"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}

variable "vault_cluster_allowed_api_inbound_cidr_blocks" {
  description = "List of CIDR blocks allowed to access Vault cliuster API service"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}

variable "vault_cluster_allowed_cluster_inbound_cidr_blocks" {
  description = "List of CIDR blocks allowed to access Vault cliuster services"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}

variable "vault_elb_allowed_inbound_cidr_blocks" {
  description = "List of CIDR blocks allowed to access Vault API ELB"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}

variable "consul_cluster_allowed_ssh_cidr_blocks" {
  description = "List of CIDR blocks allowed to access Consul cluster via SSH"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}

variable "consul_cluster_allowed_inbound_cidr_blocks" {
  description = "List of CIDR blocks allowed to access Consul cluster services"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}

variable "consul_client_allowed_inbound_cidr_blocks" {
  description = "List of CIDR blocks allowed to participate in Consul client LAN gossip"
  type        = list(string)
  default     = ["0.0.0.0/0"]
}