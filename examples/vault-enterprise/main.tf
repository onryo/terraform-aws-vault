...
module "vault_cluster" {
  ...
  allowed_ssh_cidr_blocks              = var.vault_cluster_allowed_ssh_cidr_blocks
  allowed_api_inbound_cidr_blocks      = var.vault_cluster_allowed_api_inbound_cidr_blocks
  allowed_cluster_inbound_cidr_blocks  = var.vault_cluster_allowed_cluster_inbound_cidr_blocks
...
module "security_group_rules" {
  ...
  allowed_inbound_cidr_blocks = var.consul_client_allowed_inbound_cidr_blocks
}
...
module "vault_elb" {
  ...
  # To make testing easier, we allow requests from any IP address here but in a production deployment, we *strongly*
  # recommend you limit this to the IP address ranges of known, trusted servers inside your VPC.
  allowed_inbound_cidr_blocks = var.vault_elb_allowed_inbound_cidr_blocks
...
module "consul_cluster" {
  ...
  allowed_ssh_cidr_blocks     = var.consul_cluster_allowed_ssh_cidr_blocks
  allowed_inbound_cidr_blocks = var.consul_cluster_allowed_inbound_cidr_blocks
  ssh_key_name                = var.ssh_key_name
}
